...
var video_list = [
    ...
    [ VIDEO_TYPE_YOUTUBE, get_youtube_uri( TAIWAN_THREE_NAP_NEWS ), 'TAIWAN_THREE_NAP_NEWS' ],
    [ VIDEO_TYPE_YOUTUBE, get_youtube_uri( HKO_YOUTUBE_VIDEO_ID ), 'hko weather forecast' ],
    [ VIDEO_TYPE_YOUTUBE, get_youtube_uri( TAIWAN_NEWS_CH51 ), 'TAIWAN_NEWS_CH51' ],
