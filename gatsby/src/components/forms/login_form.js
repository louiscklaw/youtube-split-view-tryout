...
function LoginForm(props){
  ...
  let {
    ...
    firebaseLogout,
    user_info
  } = React.useContext(firebase_mixins_context)

  let [login_status, setLoginStatus] = React.useState()

  React.useEffect(()=>{
    let form_email_password = document.querySelector('#email_password_login_form')
  ...
  return(
    <>
      ...
      <form className={active_style.emailPasswordLogin} id="email_password_login_form">
        <input
          type="email"
